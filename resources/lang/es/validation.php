...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes personalizar los mensajes de error de validación
    | que se muestran al usuario cuando falla una regla.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes personalizar los atributos para que aparezcan
